...
Items in **bold** are the things I am currently working on.
...
- [ ] Read Keras Documentation and Example code to quickly understand its structure [here](https://keras.io/getting-started/sequential-model-guide/)
